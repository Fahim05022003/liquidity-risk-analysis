...
export const analysisResults = pgTable('analysis_results', {
  ...
  messageBn: text('messageBn').notNull(),
  evidence: text('evidence').notNull(),
  recommendedAction: text('recommendedAction').notNull(),
  physicalCash: integer('physicalCash').notNull(),
  bkashBalance: integer('bkashBalance').notNull(),
  nagadBalance: integer('nagadBalance').notNull(),
  rocketBalance: integer('rocketBalance').notNull(),
